...
/** Determines if this node contains the specified entity.
	Parameters: entity - The entity to check for
	Returns: true if this node contains entity, or false if this node does not contain entity */
ABoolean
...
/** Gets the entities contained in this node.
	...
	Returns: The set of entities contained in this Node. */
AOwlEntitySet
...
/** Gets the entities contained in this node minus the specified entitie.
	...
	Parameters:
		Entity - The entity that, is contained within this node, but should not be included in the
		return set.
	Returns:
...
/** Gets the entities contained in this node minus the bottom entity.
	...
	Returns:
		The set of entities contained within this node minus the bottom entity.
...
/** Gets the entities contained in this node minus the top entity.
	...
	Returns:
		The set of entities contained within this node minus the top entity.
...
/** Gets one of the entities contained in this entity set.
	...
	Returns: An entity from the set of entities contained within this node. */
AOwlEntity
...
/** Gets the number of entities contained in this Node.
	Returns: The number of entities contained in this node.
	Use GetCount() */
AInt
...
/** Determines if this Node contains just one entity.
	Returns: true if this Node contains just one entity, otherwise false */
ABoolean
