 ...
 * Created 21.12.2012
 * LastMod 21.12.2012
 * Prototype https://github.com/opencog/opencog.git/opencog/atomspace/HandleEntry.h
 */

#ifndef AAtomHandleEntry_H
#define AAtomHandleEntry_H
...
AInt AHandleEntry_ExistingObjects = 0;
...
typedef AHandleEntry_Type* AHandleEntry;
...
void
afunc AHandleEntry_Init(Handle);
...
AHandleEntry
afunc HandleEntry_New(Handle h)
{
    init(h);
}
